...
const Role = ({ description, skills }: RoleProps) => {
  ...
  return (
    <div className='justify-center md:px-8 py-16 flex flex-col-reverse md:flex-row bg-gradient-to-r from-indigo-500 to-indigo-800 xl:px-96 font-medium text-white/70 md:divide-x-2'>
      ...
      <div className='px-8 flex flex-col w-fit'>
        <p className='flex mb-8 text-3xl whitespace-pre-wrap font-semibold'>My Role</p>
