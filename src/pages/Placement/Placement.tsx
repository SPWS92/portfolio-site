...
const Placement = () => {
  ...
  return (
    <div className='flex-grow overflow-y-auto text-gray-800 font-medium'>
      <Header
        name={placement?.client ?? placement?.company}
        clientDescription={placement?.clientDescription}
        findOutMore={placement?.companyLink} />
      <AboutTheProduct
        product={placement?.product}
        summary={placement?.productSummary}
        features={placement?.keyFeatures} />
      <ShowCase showCaseItems={placement?.showCaseItems} />
      <Role
        description={placement?.myRole}
