      ...
      <div className={`${height <= 375 ? 'h-fit' : 'h-screen'} relative bg-gradient-to-r from-indigo-500 to-indigo-800 overflow-hidden flex flex-col font-entry`}>
          ...
          <div className='flex flex-col lg:flex-row items-center'>
            <div className='flex flex-col text-opacity-50'>
              ...
              <div className='mt-4 flex flex-col space-y-3 sm:flex-row sm:space-x-3 sm:space-y-0'>
                <NavLink
                  to='/about-me'
                  className='rounded-full text-white border py-2 px-4 w-44 text-opacity-70 text-center hover:bg-white/20 hover:text-white/90 text-lg'>About me</NavLink>
                <NavLink
                  to='/portfolio'
                  className='rounded-full text-white border py-2 px-4 w-44 text-opacity-70 text-center hover:bg-white/20 hover:text-white/90 text-lg'>Portfolio</NavLink>
              </div>
            </div>
            <img
        ...
        <div className={`absolute flex bottom-0 w-full ${height > 499 ? 'justify-center' : 'justify-end'}`}>
          <svg
            ...
            strokeWidth={1.5}
            stroke='white'
            className='w-12 h-12 flex animate-bounce'>
            <path
              strokeLinecap='round'
