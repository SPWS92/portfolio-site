...
const portfolioData = [
  ...
  },
  {
    ...
    myRole: 'When I inherited the lead Front-end developer responsibilities of MAST, we as a team also inherited the project "Class Direct" from a team in Kuala Lumpur. Similarly to MAST, my role was to support junior members of the team whilst helping plan, design and implement features alongside fixing bugs.\n\nClass Direct used a combination of AngularJJ, Pug, no knowledge transfer and little to no warning that the project was coming. Due to this, we had the interesting task of bringing ourselves up to speed with the codebase and its capabilities. The benefit of working on Class Direct and MAST at the same time was that I could now see the full picture of what BAE had been delivering for Lloyd\'s Register.',
    keyFeatures: [
      {
        id: 1,
  ...
  },
  {
    ...
    productSummary: 'The Squad Health Check (SHC) tool was designed and developed with the purpose of offering a bespoke and customisable tool for Scrum teams to use within BAE Systems Applied Intelligence. This tool was used to assist the squad in completing and recording their Squad Health Checks. Due to the focus on continuous improvements the SHC tool allowed the user to compare scores against previous health checks.',
  ...
  },
  {
    ...
    productSummary: 'Dynamo was a product of three ambitious developers working at AND Digital who were allowed to build the application via the Incubator initiative offered by AND Digital. This initiative allowed the developers to take advantage of the expertise and skills of the many professionals that AND have to offer.\nThe purpose of Dynamo is to promote a greener and healthier lifestyle using a mobile application developed with React Native that will track the user\'s travel and offer them reward points based on their length of activity. As Dynamo is only designed to give points via walking, running and cycling, an anti-cheat system was also developed.',
    myRole: 'My time on Dynamo was fairly short lived as it was an incubator project at AND that I was placed on whilst my permanent position was being finalised, although, my responsibilities were no different as to if I was on client. The majority of the team consisted of graduate developers new to React Native so I was tasked with supporting them and helping them develop their skills.\n\nAs it was known I would only be on the project for a short period, I was asked to pick up the most pressing ticket, anti-cheating. Although I was new to Swift I was able to implement this feature on IOS using CLLocationManager.',
    keyFeatures: [
      {
        id: 1,
        heading: 'Responsive Design',
  ...
  },
  {
    ...
    myRole: 'I entered the Customer Hub team with little industry experience in React but very quickly found my feet as I\'d spent a considerable amount of my personal time learning the library and building my own websites.\n\nAlthough on the service it looked like we were only working with two web pages, it very quickly became apparent that the codebase we were working with was very large, with many new aspects I hadn\'t previously had to consider. I\'d never needed to work with a CMS, feature toggles or A\\B testing but I very quickly became the SME for all of these within our project. Not only was I heavily involved in the planning and development of new features but I was also one of two people with admin/production privileges for adding new content, feature toggles and A\\B tests.\n\The high level access and knowledge of Sky\'s implementation of Content Stack set me up for a great position on a future Sky project.',
    keyFeatures: [
      {
        id: 1,
        heading: 'Responsive Design',
  ...
  },
  {
    ...
    productSummary: 'At the most basic level, the purpose of my Portfolio website is to enrich my CV. Due to a career in consulting and contracting, a CV can become extremely long, whereas it is normally advised to keep it short. Having this Portfolio allows me to focus my CV for a particular role and link the Portfolio to allow others to understand more about my experiences, and the journey I have taken to get to this point.\n\nThe Portfolio website will have two primary pages, the "About me" page where my history in the Software industry can be discovered, and my Portfolio, a page that lists my industry and personal experience.',
    keyFeatures: [
      {
        id: 1,
        heading: 'Responsive Design',
